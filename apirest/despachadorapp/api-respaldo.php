...
class Api{
	...
	public function obtenerDatos($noTarjeta, $claveestacion){
		...
		(Select sum(restante) from servicios where idcliente = '".$idcte."') as saldoservicios,

		(Select IFNULL(SUM(restante), 10 ) from servicios where idcliente = '".$idcte."' and tarjeta = '".$noTarjeta."') as saldotarjeta
