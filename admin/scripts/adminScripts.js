...
function serVe(n){
    let mensaje = document.createElement("div");
        ...
        mensaje.classList.add("alertaCS");
        let lbl = document.createElement("label");
        lbl.innerHTML= "¿Desea cancelar lel servicio #"+n+"?";
        mensaje.append(lbl);
        let hr = document.createElement("hr");
        mensaje.append(hr); 
        let hr1 = document.createElement("hr");
    ...
    for( var element of abonos){
        var rw = tbl.insertRow();
            ...
            if(element.estacion==1){
                cll1.innerHTML = "PETROMAR SUC. SANTA FE";
            }
            if(element.estacion==2){
                cll1.innerHTML = "PETROMAR SUC. LEY DEL MAR";
            }
            if(element.estacion==3){
                cll1.innerHTML = "PETROMAR LIBRAMIENTO";
            }
            if(element.estacion==4){
                cll1.innerHTML = "PETROMAR SUC. MUNICH";
            }
            if(element.estacion==5){
                cll1.innerHTML = "PETROMAR INSURGENTES";
            }
            if(element.estacion==6){
                cll1.innerHTML = "PETROMAR LOPEZ SAENZ";
            }
            if(element.estacion==7){
                cll1.innerHTML = "RIO PRESIDIO";
            }
