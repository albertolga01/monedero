...
$cte = $_POST['cte'];
  ...
  $Query = "SELECT * FROM abonos WHERE IDclienteAbono='{$cte}' order by IDabono desc limit 1";
  ...
  $producto=$producto1['nombre'];*/
		  ...
		  $enviado = sendMail($nombre,$correo,$importe,$fecha,$concepto);
			if($enviado){
				echo "Enviado";
			}else{
        echo "0";
...
function sendMail($nombre,$correo,$importe,$fecha,$concepto){
    try{
                      ...
                      <tr>
                        <td>
                          <div class="text" style="text-align: center;">
                            <h2 style="color: #000;">Notificaci&oacute;n de Abono</h2>
                            <p><b>Le informamos que se ha realizado un abono con las siguientes caracter&iacute;sticas.</b></p>
                            <p><b>Fecha: '.formatDate($fecha).'</b></p>
                            <p><b>Concepto: '.$concepto.'</b></p>
