...
if(isset($_FILES["pdf"]["tmp_name"])){
   ...
   //
	 ...
	 if(move_uploaded_file($_FILES["pdf"]["tmp_name"],  $ruta)){
		 //
		 $enviado = sendMail($nombre,$folio,$fecha,$importe, $tipocomprobante,$contacto, $nombreC);
			if($enviado){
				echo "1";
			}else{
        echo "0";
...
function sendMail($nombre,$folio,$fecha,$importe,$tipocomprobante,$contacto,$nombreC){
  //echo $contacto;
    try{
                ...
                <tr>
                  <td valign="middle" class="hero" style="background-image: url(https://monedero.grupopetromar.com/admin/imagenes/mosaicos.png); background-size: cover; height: 400px;">
                    <table>
                      <tr>
                        <td>
                          <div class="text" style="padding: 0 3em; text-align: center; color: #000;">
                            <h2 style="color: #000;">Notificaci&oacute;n de emisi&oacute;n de comprobante</h2>
                            <p><b>Le informamos que OPERADORA Y SERVICIOS EMPRESARIALES SA DE CV emiti&oacute; para usted un Comprobante Fiscal Digital por Internet (CFDI) con las siguientes caracter&iacute;sticas.</b></p>
                            <p><b>Folio: '.$folio.'</b></p>
                            <p><b>Fecha y hora de emisi&oacute;n: '.$fecha.'</b></p>
                            <p><b>Tipo de comprante: '.$tipocomprobante.'</b></p>
                            <p><b>Monto Total: $'.$importe.'</b></p>
